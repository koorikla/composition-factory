...
func New(o Options) (http.Handler, error) {
	...
	mux.HandleFunc("POST /api/blueprint/adopt", srv.handleAdoptBlueprint)
	...
	mux.HandleFunc("POST /api/blueprint/resources", srv.handleAddResource)
	...
	mux.HandleFunc("POST /api/functions", srv.handleAddFunction)
